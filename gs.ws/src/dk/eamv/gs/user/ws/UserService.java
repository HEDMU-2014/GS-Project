 ...
 * 2016-03-29T20:17:25.905+02:00
 * Generated source version: 3.0.5
 * 
 */
@WebServiceClient(name = "UserService", 
                  wsdlLocation = "file:/C:/Users/hi/git/GS-Project/gs.ws/wsdl/user.wsdl",
...
public class UserService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/hi/git/GS-Project/gs.ws/wsdl/user.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/hi/git/GS-Project/gs.ws/wsdl/user.wsdl");
        }
        WSDL_LOCATION = url;
    }
